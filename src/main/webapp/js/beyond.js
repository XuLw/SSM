...
function widgetButtonMax(obj)
{
	var widget = $(obj).parents(".widget").eq(0);
    var button = $(obj).find("i").eq(0);
...
function widgetButtonCollapse(obj)
{
	var widget = $(obj).parents(".widget").eq(0);
...
function widgetButtonDispose(obj)
{
	var toolbarLink = $(obj);
